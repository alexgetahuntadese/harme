...
const ProgressOverTime = ({ attempts }: ProgressOverTimeProps) => {
      ...
      <Card className="bg-white/5 border-white/20">
        ...
        <CardContent className="text-center py-8">
          <p className="text-gray-400">
            Complete at least 2 quizzes to see your progress trend
          </p>
        </CardContent>
      </Card>
    );
  ...
  // Sort attempts by date and prepare chart data
  ...
  return (
    <Card className="bg-white/5 border-white/20">
      <CardHeader>
        ...
        <p className="text-gray-400 text-sm">Your score progression across recent quizzes</p>
      </CardHeader>
      <CardContent>
        ...
        <div className="flex justify-center gap-6 mt-4 text-sm">
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-400">Individual Scores</span>
          </div>
          <div className="flex items-center gap-2">
